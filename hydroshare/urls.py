...
urlpatterns = i18n_patterns("",
    ...
    url(r'^oauth/$', theme.oauth, name='oauth'),
    url(r'^scidas_virtual_app/(?P<res_id>[A-z0-9\-_]+)/(?P<cluster>[A-z0-9\-_]+)',
        theme.create_scidas_virtual_app, name='scidas_virtual_app'),
    url(r'^accounts/login/$', theme.login, name='login'),
    url(r'^cs-oauth/', include('social_django.urls', namespace='social')),
