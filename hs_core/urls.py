...
urlpatterns = [
    ...
    url(r'^_internal/group_dua_signoff/(?P<token>[-\w]+)/(?P<uidb36>[-\w]+)/(?P<membership_request_id>[0-9]+)/',
        views.group_dua_signoff, name='group_dua_signoff'),
    ...
    url(r'^_internal/(?P<shortkey>[0-9a-f-]+)/publish/(?P<publish_type>[a-z]+)/$', views.publish),
    url(r'^_internal/create-resource/$', views.create_resource_select),
